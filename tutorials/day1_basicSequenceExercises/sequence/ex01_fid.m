...
%% Tasks:
% ex01_FID is the simplest free induction decay (FID) sequence. 
% Run ex01_FID to get familinar with using Pulseq to design 
% sequences in Matlab
clear ; close all; clc ;
...
seq.write(['ex01_fid_' userID '.seq']) ;       % Write to pulseq file
