...
%% Tasks:
% This exercise starts with ex15_gre2d_RFspoil. With GRE combined with
% gradient spoiling and RF spoiling, we have generated the famous FLASH
% sequence. We can make this sequence faster by doing a "gradient surgery"
% for the readout gradient and spoiling. Could you try to do this surgery by
% yourself?
clear ; close all; clc ;
...
% [gx1, ~] = mr.splitGradientAt(gx, the time point to split) ;

% gradient spoiling
% gxSpoil = mr.makeExtendedTrapezoidArea(the channel of gxSpoil, the amplitude of the first point of gxSpoil, the amplitude of the last point of gxSpoil, the total area, sys) ;
...
seq.write(['ex16_flash_fasterTming_' userID '.seq']) ;       % Write to pulseq file
