...
seq_file_path = 'sol03_se_crushers_chen.seq' ;
...
exportgraphics(gcf,'sol03_kspace.png',...
    'ContentType','vector',...
...
w_axis = (-adc_len/2:(adc_len/2-1))/((t_adc(end,1,1)-t_adc(1,1,1))/(adc_len-1)*adc_len)/twix_obj.hdr.Dicom.lFrequency*1e6' ;
figure ;
...
exportgraphics(gcf,'sol03_im.png',...
    'ContentType','vector',...
    'BackgroundColor','none') ;